                ...
                <div className="flex items-center justify-between">
                    <div>
                        ...
                        {chirp.created_at !== chirp.updated_at && (
                            <small className="text-sm text-gray-600"> &middot; editado</small>
                        )}
                    </div>
                    ...
                    {chirp.user.id === auth.user.id && (
                        <Dropdown>
                            ...
                            <Dropdown.Content>
                                <button
                                    className="block w-full px-4 py-2 text-left text-sm leading-5 text-gray-700 transition duration-150 ease-in-out hover:bg-gray-100 focus:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-800 dark:focus:bg-gray-800"
